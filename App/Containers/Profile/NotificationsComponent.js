      ...
      <SafeAreaView style={{flex: 1, height: '100%'}}>
        <View style={{padding: Metrics.doubleBaseMargin}}>
          <Text style={{...Fonts.style.h4, color: Colors.text}}>
            {I18n.t('reportsScreen_title')}
          </Text>
          <Text style={{...Fonts.style.description, color: Colors.text}}>
            {I18n.t('reportsScreen_subtitle')}
          </Text>
        </View>
        <ScrollView
          style={{
              ...
              return (
                <View>
                  <BeachReportCard
                    ...
                    key={report[0].id}
                    item={this.getBeachSpotItem(report[0])}
                    data={report}
...
const mapDispatchToProps = dispatch => ({
  ...
  getLatestReports: () => dispatch(BeachSpotActions.getLatestReportsRequest()),
});
